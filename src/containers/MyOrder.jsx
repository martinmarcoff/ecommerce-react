  ...
  return (
    <aside className="MyOrder">
      <div className="title-container">
        <img
          onClick={handleClick}
          src="https://cdn-icons-png.flaticon.com/512/61/61178.png?w=740&t=st=1680289411~exp=1680290011~hmac=fbd59098b754c41309f25d81404acda817f029e9ff043368f91fb654c54276b2"
          alt="arrow"
        />
